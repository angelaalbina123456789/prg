class pr002 {
	public static void main(String args[]) {
		...
		int i11;
		b11 = 10;
		i11 = b11 * b11; //При операции перемножения 2 переменых типа byte получается повышения результата до типа int

		b11 = 10;
		b11 = (byte)(b11 * b11); //Необходимо приведения типа int к типу byte
